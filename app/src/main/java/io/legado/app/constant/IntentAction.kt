...
object IntentAction {
    ...
    const val prev = "prev"
    const val next = "next"
    const val localTtsNext = "localTtsNext"
    const val localTtsPrev = "localTtsPrev"
    const val localTtsState = "localTtsState"
    const val localTtsProgress = "localTtsProgress"
