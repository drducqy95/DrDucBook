...
class PermissionActivity : AppCompatActivity() {
        ...
        showSettingDialog(permissions, rationale) {
            try {
                when (requestType) {
                    ...
                    Request.TYPE_REQUEST_IGNORE_BATTERY_OPTIMIZATIONS ->
    ...
    private fun openIgnoreBatteryOptimizationSettings() {
        ...
        runCatching {
            ...
            // Some vendor ROMs do not expose the one-app confirmation screen.
            // Fall back to the app details page so the user can enable background use manually.
            openSettingsActivity()
        }
    }
