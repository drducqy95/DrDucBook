...
interface BookChapterDao {
    ...
    suspend fun getAll(): List<BookChapter>
    ...
    @Query("SELECT COUNT(*) FROM chapters WHERE url IN (:urls) AND bookUrl LIKE 'audiobook://%'")
    fun countImportedAudiobookTracks(urls: List<String>): Int
