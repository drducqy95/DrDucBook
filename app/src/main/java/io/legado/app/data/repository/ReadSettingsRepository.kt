...
data class ReadPreferences(
    ...
    val italicizeDialogue: Boolean = false,
...
class ReadSettingsRepository(
    ...
    suspend fun setItalicizeDialogue(value: Boolean) =
        settingsRepository.putBoolean(PreferKey.italicizeDialogue, value)
    ...
    private fun Preferences.toReadPreferences(): ReadPreferences {
        ...
        return ReadPreferences(
            ...
            italicizeDialogue = this[Keys.ItalicizeDialogue] ?: false,
    ...
    private object Keys {
        ...
        val ItalicizeDialogue = booleanPreferencesKey(PreferKey.italicizeDialogue)
