...
class SearchContentRepository {
    ...
    private fun searchKey(
        ...
        // Plain JVM tests do not start Koin, while ReadBookConfig resolves its repository from
        // Koin during class initialization. Session bookkeeping must remain usable without the
        // Android application graph; the app path still reads the configured value normally.
