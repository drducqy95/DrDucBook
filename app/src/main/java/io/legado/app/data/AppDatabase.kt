...
@Database(
    ...
    entities = [Book::class, BookGroup::class, BookSource::class, BookChapter::class,
        ...
        AiChatMessage::class, AiMemory::class, AiMemoryFts::class,
        ...
        SourceCheckRunEntity::class, SourceCheckStageResultEntity::class,
        MediaDownloadTaskEntity::class, MediaDownloadItemEntity::class,
        BrowserBookmarkEntity::class, SourceBookmarkPreferenceEntity::class,
        CookieVaultEntity::class, AiCustomTool::class, AiCustomToolVersion::class],
...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract val bookSourceHealthDao: BookSourceHealthDao
    abstract val sourceCheckDao: SourceCheckDao
    ...
    abstract val browserBookmarkDao: BrowserBookmarkDao
    ...
    abstract val aiCustomToolDao: AiCustomToolDao
    abstract val aiMemoryDao: AiMemoryDao
    abstract val aiPromptPresetDao: AiPromptPresetDao
    abstract val aiRouterDao: AiRouterDao
    abstract val aiSkillDao: AiSkillDao
    abstract val quickDictionaryDao: QuickDictionaryDao
    abstract val mediaDownloadDao: MediaDownloadDao
