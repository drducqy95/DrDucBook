...
fun ChangeSourceSheet(
        ...
        viewModel.effects.collectLatest { effect ->
            when (effect) {
                ...
                is ChangeBookSourceEffect.ShowMessageResource ->
                    context.toastOnUi(resources.getString(effect.messageRes))
            }
        }
    }
    ...
    val performAction = fun(searchBook: SearchBook, replace: Boolean) {
        ...
        viewModel.getToc(
            ...
            onError = {
                ...
                context.toastOnUi(
                    if (replace) R.string.change_source_failed else R.string.add_book_failed
                )
            }
        )
    }
                ...
                contentDescription = stringResource(R.string.more_menu)
                    ...
                    RoundDropdownMenu(
                        ...
                        RoundDropdownMenuItem(
                            text = stringResource(R.string.validate_author),
                        ...
                        RoundDropdownMenuItem(
                            text = stringResource(R.string.load_details),
                            isSelected = loadInfo,
                            onClick = {
                        ...
                        RoundDropdownMenuItem(
                            text = stringResource(R.string.load_toc),
                            isSelected = loadToc,
                            onClick = {
                        ...
                        RoundDropdownMenuItem(
                            text = stringResource(R.string.show_more_information),
    ...
    ChangeSourceMigrationOptionsSheet(
        ...
        title = stringResource(R.string.change_source_options),
