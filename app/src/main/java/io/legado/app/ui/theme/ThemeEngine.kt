...
object ThemeEngine {
    ...
    private fun resolveDynamicColorScheme(
        ...
        return resolvePlatformDynamicColorScheme(context, darkTheme)
    }

    @TargetApi(Build.VERSION_CODES.S)
    private fun resolvePlatformDynamicColorScheme(
        context: Context,
        darkTheme: Boolean,
    ): ColorScheme {
    ...
    private fun ColorScheme.applyTransparentIfNeeded(
        ...
        return withTransparentSurfaceRamp(darkTheme)
    }
}
