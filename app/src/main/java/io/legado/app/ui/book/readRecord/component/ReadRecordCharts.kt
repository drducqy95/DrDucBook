    ...
    GlassCard(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                AppText(
                    stringResource(R.string.reading_duration_distribution),
                ...
                Row(
                    ...
                    data.forEachIndexed { index, (date, time) ->
                        ...
                        val labelText = when (period) {
                            ReadPeriod.YEAR -> date.month.getDisplayName(TextStyle.SHORT, locale)
                            ReadPeriod.WEEK -> date.dayOfWeek.getDisplayName(TextStyle.NARROW, locale)
