...
@Stable
data class TranslationOptionUi(
    val value: String,
    val label: String,
)
...
@Stable
data class TranslationProgressUiState(
    val chapterTitle: String = "",
    val provider: String = "",
    val aiSelectionLabel: String = "",
    val aiSelectionIsCombo: Boolean = false,
    val targetLanguage: String = "",
    val providerOptions: ImmutableList<TranslationOptionUi> = persistentListOf(),
    ...
    val errorMessage: String? = null,
    val logs: ImmutableList<String> = persistentListOf(),
    val hasCachedTranslation: Boolean = false,
    val revisionStatus: RevisionStatus? = null,
    val revisionStale: Boolean = false,
    val displayTranslation: Boolean = false,
    val autoTranslateEnabled: Boolean = false,
    val autoTranslateWifiOnly: Boolean = true,
    val autoTranslateNextChapters: Int = 3,
    val autoTranslateQueueRunning: Boolean = false,
    val autoTranslateCompletedChapters: Int = 0,
...
data class ReadBookUiState(
    ...
    val readerContentMode: ReaderContentMode = ReaderContentMode.RAW,
    val availableReaderContentModes: ImmutableList<ReaderContentMode> = persistentListOf(
    ...
    val isImportingLocalTtsModel: Boolean = false,
...
sealed interface ReadBookIntent {
    ...
    data class SelectReaderContentMode(val mode: ReaderContentMode) : ReadBookIntent
    data object OpenTranslation : ReadBookIntent
    data object StartCurrentChapterTranslation : ReadBookIntent
    data object CancelCurrentChapterTranslation : ReadBookIntent
    ...
    data class SetQuickDictionaryRaw(val value: String) : ReadBookIntent
    ...
    data class AdjustQuickDictionarySelection(
        val action: QuickDictionarySelectionAction,
    ) : ReadBookIntent
    data class SelectQuickDictionaryMappingAlternative(val index: Int) : ReadBookIntent
    data object DismissQuickDictionaryMappingAlternatives : ReadBookIntent
    ...
    data class FontFileSelected(val uri: Uri, val isTitleFont: Boolean) : ReadBookIntent
    ...
    data class OpenFontFilePicker(val isTitleFont: Boolean) : ReadBookIntent
    ...
    data object ImportLocalTtsModel : ReadBookIntent
    data object OpenLocalTtsModelCatalog : ReadBookIntent
    data class OpenLocalTtsModelCatalogItem(val url: String) : ReadBookIntent
    data class ImportLocalTtsModelSelected(val uri: Uri) : ReadBookIntent
    data class DeleteLocalTtsModel(val modelId: String) : ReadBookIntent
...
sealed interface ReadBookEffect {
    ...
    data class OpenEntityAnalyzer(val bookUrl: String) : ReadBookEffect
    data class OpenTranslationRevision(
        val bookUrl: String,
        val chapterIndex: Int,
        val targetLanguage: String,
        val provider: String,
    ...
    data class OpenUrl(val url: String) : ReadBookEffect
    ...
    data class OpenFontFilePicker(val isTitleFont: Boolean) : ReadBookEffect
    ...
    data object OpenLocalTtsModelImportPicker : ReadBookEffect
