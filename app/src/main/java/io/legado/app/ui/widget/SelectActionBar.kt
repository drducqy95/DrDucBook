...
import com.drducbook.app.databinding.ViewSelectActionBarBinding
...
class SelectActionBar @JvmOverloads constructor(
    ...
    fun upCountView(selectCount: Int, allCount: Int) = binding.run {
        ...
        //重置全选的文字
        val numberFormat = NumberFormat.getIntegerInstance(Locale.ROOT)
        tvCount.text = numberFormat.format(selectCount)
        tvCountAll.text = numberFormat.format(allCount)
