    ...
    private fun selectSource(searchBook: SearchBook) {
        ...
        viewModelScope.launch {
            try {
                ...
                _effects.tryEmit(ChangeChapterSourceEffect.ShowToast(
                    appCtx.getString(R.string.bookshelf_manage_toc_failed)
                ))
            }
        }
    }
            ...
            try {
                ...
                _effects.tryEmit(
                    ChangeChapterSourceEffect.ShowToast(
                        e.localizedMessage ?: appCtx.getString(R.string.load_content_failed)
                    )
                )
            }
        }
