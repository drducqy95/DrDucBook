...
class ReadConfigViewModel(
    ...
    fun onIntent(intent: ReadConfigIntent) {
        viewModelScope.launch {
            when (intent) {
                ...
                is ReadConfigIntent.ItalicizeDialogueChanged -> {
                    ReadConfig.italicizeDialogue = intent.value
                    readSettingsRepository.setItalicizeDialogue(intent.value)
                    upLayout()
                }
    ...
    private fun ReadPreferences.toUiState(): ReadConfigUiState {
        return ReadConfigUiState(
            ...
            italicizeDialogue = italicizeDialogue,
