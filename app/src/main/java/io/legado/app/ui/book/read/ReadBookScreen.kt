...
import io.legado.app.ui.book.read.sheet.TranslationProgressSheet
import io.legado.app.ui.book.read.sheet.QuickDictionarySheet
...
fun ReadBookScreen(
    ...
    FontSelectSheet(
        ...
        onImportFont = { onIntent(ReadBookIntent.OpenFontFilePicker(isTitleFont = false)) },
    ...
    FontSelectSheet(
        ...
        onOpenFolderPicker = { onIntent(ReadBookIntent.OpenFontFolderPicker) },
        onImportFont = { onIntent(ReadBookIntent.OpenFontFilePicker(isTitleFont = true)) },
        systemTypefaces = fontSelectSystemTypefaces,
    )
    ...
    QuickDictionarySheet(
        show = state.activeSheet is ReadBookSheet.QuickDictionary,
        state = state.quickDictionary,
        onIntent = onIntent,
        onDismissRequest = dismissSheet,
    )
    AiTextCleanSheet(
