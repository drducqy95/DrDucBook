...
fun <T> HomepageModuleManageSheet(
    ...
    AppModalBottomSheet(
        ...
        AnimatedContent(
            ...
            val (_, detailState) = target
            val (targetShowCustomSetAddModules, targetBrowsingDetail) = detailState
            when {
                browseUrl != null && targetBrowsingDetail -> {
