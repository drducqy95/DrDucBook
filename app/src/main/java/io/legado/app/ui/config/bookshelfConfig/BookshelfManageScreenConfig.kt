...
class BookshelfManageScreenConfig(
    ...
    var vbookEbookUnlockCode by prefDelegate<String?>(PreferKey.vbookEbookUnlockCode, null)
    ...
    var exportContentSource by prefDelegate(
        PreferKey.exportContentSource,
        EbookExportContentSource.BOTH.value,
    )
