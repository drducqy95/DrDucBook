...
fun EffectiveReplacesSheet(
    ...
    val chineseConvertActive = chineseConverterType > 0
    val chineseConvertLabel = stringResource(R.string.chinese_converter)
    val chineseConvertItem = remember(chineseConvertLabel) {
        ReplaceRule(CHINESE_CONVERT_ID, chineseConvertLabel)
    }
