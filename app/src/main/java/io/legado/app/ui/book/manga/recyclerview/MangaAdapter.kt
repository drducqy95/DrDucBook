...
import com.drducbook.app.databinding.ItemBookMangaEdgeBinding
import com.drducbook.app.databinding.ItemBookMangaPageBinding
...
class MangaAdapter(private val context: Context) :
    ...
    var onImageReady: ((String, Drawable, AppCompatImageView) -> Unit)? = null
