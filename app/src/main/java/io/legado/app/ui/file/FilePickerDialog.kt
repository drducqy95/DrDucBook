...
import com.drducbook.app.databinding.DialogFileChooserBinding
import com.drducbook.app.databinding.ItemFilePickerBinding
import com.drducbook.app.databinding.ItemPathPickerBinding
    ...
    private fun initContentView() {
        ...
        binding.tvOk.setOnClickListener {
            if (viewModel.isSelectDir) {
                ...
                if (file == null) {
                    toastOnUi(R.string.select_file_required)
                } else {
            ...
            R.id.menu_create -> alert(R.string.create_folder) {
                ...
                okButton {
                    ...
                    if (text.isNullOrBlank()) {
                        toastOnUi(R.string.folder_name_required)
                    } else {
