...
object OtherConfig {
    ...
    var ebookExportTreeUri by prefDelegate(
        PreferKey.ebookExportTreeUri,
        null as String?
    )

    var kindleEmail by prefDelegate(
        PreferKey.kindleEmail,
        ""
    )
    ...
    var webPort by prefDelegate(
        PreferKey.webPort,
        WebServicePorts.DEFAULT_HTTP_PORT
    )
