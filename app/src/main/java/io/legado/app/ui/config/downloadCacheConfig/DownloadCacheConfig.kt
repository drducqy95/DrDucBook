...
object DownloadCacheConfig {
    ...
    /** Minimum spacing between chapter requests to the same book source. */
    var requestDelayMs by prefDelegate(
        PreferKey.cacheDownloadRequestDelayMs,
        0
    )

    /** Random value in 0..jitter added to [requestDelayMs] for every request. */
    var requestJitterMs by prefDelegate(
        PreferKey.cacheDownloadRequestJitterMs,
        0
    )
