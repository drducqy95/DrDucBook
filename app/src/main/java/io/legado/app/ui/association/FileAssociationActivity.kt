...
import com.drducbook.app.databinding.ActivityTranslucenceBinding
            ...
            if (data.isContentScheme() && data.canRead()) {
                ...
                PermissionsCompat.Builder()
                    ...
                    .onGranted {
                        ...
                        toastOnUi(R.string.storage_permission_failed)
                        handler.postDelayed(2000) {
                            finish()
                        }
                    }.request()
            ...
            runCatching {
                    ...
                    if (treeUri == null) {
                        ...
                        if (!treeDoc!!.checkWrite()) {
                            throw InvalidBooksDirException(
                                getString(R.string.reset_book_folder_permission_denied)
                            )
                        }
                ...
                when (it) {
                    is InvalidBooksDirException -> localBookTreeSelect.launch {
                        ...
                        val msg = getString(
                            R.string.import_book_failed_with_error,
                            it.localizedMessage
                        )
                        AppLog.put(msg, it)
                        toastOnUi(msg)
