...
import io.legado.app.ui.book.read.page.delegate.PaperPageDelegate
...
class ReadView(
    ...
    fun upPageAnim(upRecorder: Boolean = false) {
        ...
        when (ReadBook.pageAnim()) {
            ...
            PageAnim.paperPageAnim -> if (pageDelegate !is PaperPageDelegate) {
                pageDelegate = PaperPageDelegate(this)
            }
