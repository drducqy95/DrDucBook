...
class ReplaceEditViewModel(
    ...
    private fun copyRule() {
        viewModelScope.launch(Dispatchers.Main) {
            ...
            app.sendToClip(json)
            app.toastOnUi(R.string.rule_copied_clipboard)
        }
    }
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                if (text.isNullOrBlank()) {
                    throw NoStackTraceException(app.getString(R.string.clipboard_empty))
                }

                val pastedRule = GSON.fromJsonObject<ReplaceRule>(text).getOrNull()
                    ?: throw NoStackTraceException(app.getString(R.string.invalid_format))
                ...
                launch(Dispatchers.Main) {
                    app.toastOnUi(e.localizedMessage ?: app.getString(R.string.invalid_format))
                }
            }
        }
    }
