...
fun GlobalThemePage(
    ...
    Column(
        ...
        val pageAnimEntries = pageAnimOptions.map { stringResource(it.first) }.toTypedArray()
        val pageAnimEntryValues = pageAnimOptions.map { it.second.toString() }.toTypedArray()
                            ...
                            onClick = {
                                ...
                                onIntent(
                                    ReadBookIntent.UpdateConfig(
                                        ConfigUpdate.PageAnim(pageAnimOptions[index].second)
                                    )
                                )
                                dismiss()
                            },
