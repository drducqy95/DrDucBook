...
object ReadMangaConfig {
    ...
    var mangaTranslationEnabled by prefDelegate(
        PreferKey.mangaTranslationEnabled,
        false,
    )

    var mangaTranslationScript by prefDelegate(
        PreferKey.mangaTranslationScript,
        "CHINESE",
    )

    var mangaTranslationVerticalReading by prefDelegate(
        PreferKey.mangaTranslationVerticalReading,
        false,
    )
    ...
    fun detectMangaClickArea() {
        if (mangaClickActionTL * mangaClickActionTC * mangaClickActionTR
            ...
            * mangaClickActionBL * mangaClickActionBC * mangaClickActionBR != 0
            ...
            appCtx.toastOnUi(R.string.manga_menu_region_restored)
        }
    }
}
