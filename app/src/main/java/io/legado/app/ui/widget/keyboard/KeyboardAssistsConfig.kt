...
import com.drducbook.app.databinding.DialogMultipleEditTextBinding
import com.drducbook.app.databinding.DialogRecyclerViewBinding
import com.drducbook.app.databinding.Item1lineTextAndDelBinding
...
class KeyboardAssistsConfig : BaseDialogFragment(R.layout.dialog_recycler_view),
    ...
    private fun editKey(keyboardAssist: KeyboardAssist?) {
        alert {
            setTitle(R.string.auxiliary_keys)
