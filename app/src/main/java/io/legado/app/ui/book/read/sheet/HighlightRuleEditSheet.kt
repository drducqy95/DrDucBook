        ...
        Column(
            ...
            if (hasUnderline) {
                ...
                TinySliderSettingItem(
                    ...
                    valueRange = 0.1f..10f,
                    description = String.format(Locale.ROOT, "%.1f dp", underlineWidth),
                ...
                TinySliderSettingItem(
                    ...
                    valueRange = 0f..20f,
                    description = String.format(Locale.ROOT, "%.1f dp", underlineOffset),
            ...
            if (hasBgImage && bgImage.isNotBlank()) {
                ...
                TinySliderSettingItem(
                    ...
                    value = bgImageScale,
                    valueRange = 0.1f..5f,
                    description = String.format(Locale.ROOT, "%.1fx", bgImageScale),
            ...
            if (allConfigNames.isNotEmpty()) {
                SectionTitle(stringResource(R.string.apply_layout))
                LazyRow(
                    ...
                    item {
                        ...
                        NormalCard(
                            ...
                            AppText(
                                stringResource(R.string.global_scope),
            ...
            // === Section 4: Font ===
            SectionTitle(stringResource(R.string.font_replacement))
            TinySwitchSettingItem(
