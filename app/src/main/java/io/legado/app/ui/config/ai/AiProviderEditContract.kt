...
data class AiProviderEditUiState(
    ...
    val fallbackModels: ImmutableList<AiProviderModelUi> = persistentListOf(),
    val translationPrompts: ImmutableList<AiProviderPromptUi> = persistentListOf(),
    val selectedTranslationPromptId: String = "",
...
sealed interface AiProviderEditIntent {
    ...
    data class SelectTranslationPrompt(val presetId: String) : AiProviderEditIntent
