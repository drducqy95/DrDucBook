...
import com.drducbook.app.databinding.ActivityBookSourceEditBinding
...
//        source.ruleReview = reviewRule
    ...
    override fun helpActions(): List<SelectItem<String>> {
        val helpActions = arrayListOf(
            SelectItem(getString(R.string.insert_url_option), "urlOption"),
            SelectItem(getString(R.string.book_source_tutorial), "ruleHelp"),
            SelectItem(getString(R.string.javascript_tutorial), "jsHelp"),
