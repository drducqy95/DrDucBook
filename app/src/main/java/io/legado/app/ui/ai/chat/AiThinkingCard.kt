...
fun AiThinkingCard(
    ...
    val headerTitle = when {
        hasTools && hasReasoning -> stringResource(R.string.ai_thinking_tools)
        hasTools -> stringResource(R.string.ai_tool_calls)
        isStreaming -> stringResource(R.string.ai_thinking_active)
    ...
    Column(
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            if (!hasContent) {
                ...
                AppText(
                    text = stringResource(R.string.ai_no_output),
                    style = LegadoTheme.typography.labelSmall,
        ...
        if (hasContent) {
            MarkdownBlock(
                content = buildToolContent(
                    tool = tool,
                    inputLabel = stringResource(R.string.ai_tool_input_label),
                    resultLabel = stringResource(R.string.ai_tool_result),
                ),
                style = LegadoTheme.typography.bodySmall.copy(
                    color = LegadoTheme.colorScheme.onSurfaceVariant
                ),
