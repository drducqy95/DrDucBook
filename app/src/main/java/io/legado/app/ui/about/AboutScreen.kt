...
private fun MaterialAboutScreen(
    ...
    val creditsTitle = stringResource(R.string.about_open_source_credits)
    val projectUrl = stringResource(R.string.github_url)
    val contributorsUrl = stringResource(R.string.contributors_url)
    ...
    AppScaffold(
        ...
        Column(
            ...
            Image(
                painter = painterResource(R.drawable.drducbook_icon_foreground),
            ...
            Row(
                ...
                FilledTonalIconButton(onClick = { onIntent(AboutIntent.OpenUrl(projectUrl)) }) {
                    Icon(
            ...
            SplicedColumnGroup(
                ...
                SettingItemWithDivider {
                    SettingItem(
                        ...
                        onClick = { onIntent(AboutIntent.OpenUrl(contributorsUrl)) }
                    )
                }
                SettingItemWithDivider {
                    SettingItem(
