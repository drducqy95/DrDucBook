        ...
        LazyColumn(
            ...
            item {
                ...
                SplicedColumnGroup(title = stringResource(R.string.download_setting)) {
                    ...
                    SliderSettingItem(
                        title = stringResource(R.string.cache_download_request_delay),
                        description = stringResource(
                            R.string.cache_download_request_delay_summary,
                            DownloadCacheConfig.requestDelayMs,
                        ),
                        value = DownloadCacheConfig.requestDelayMs.toFloat(),
                        defaultValue = 0f,
                        valueRange = 0f..15_000f,
                        steps = 59,
                        onValueChange = {
                            DownloadCacheConfig.requestDelayMs = it.toInt().coerceAtLeast(0)
                        },
                    )

                    SliderSettingItem(
                        title = stringResource(R.string.cache_download_request_jitter),
                        description = stringResource(
                            R.string.cache_download_request_jitter_summary,
                            DownloadCacheConfig.requestJitterMs,
                        ),
                        value = DownloadCacheConfig.requestJitterMs.toFloat(),
                        defaultValue = 0f,
                        valueRange = 0f..15_000f,
                        steps = 59,
                        onValueChange = {
                            DownloadCacheConfig.requestJitterMs = it.toInt().coerceAtLeast(0)
                        },
                    )
                }
