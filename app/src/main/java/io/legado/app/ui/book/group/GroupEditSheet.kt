...
fun GroupEditContent(
    ...
    Column(
        ...
        CompactSwitchSettingItem(
            title = stringResource(R.string.tag_match_rule),
            description = stringResource(
                if (showPattern) {
                    R.string.tag_match_rule_enabled_desc
                } else {
                    R.string.tag_match_rule_disabled_desc
                }
            ),
            checked = showPattern,
        ...
        ConfirmDismissButtonsRow(
            ...
            onConfirm = {
                if (groupName.isEmpty()) {
                    appCtx.toastOnUi(R.string.group_name_required)
                } else {
                    if (group != null) {
                        viewModel.upGroup(
                            group.copy(
        ...
        onClick = {
            if (group != null) {
                viewModel.clearCover(group) {
                    ...
                    appCtx.toastOnUi(R.string.cover_reset)
                }
            } else {
                onCoverPathChange(null)
            }
