...
sealed interface BookInfoSheet {
    ...
    data object EbookExport : BookInfoSheet
...
sealed interface BookInfoEffect {
    ...
    data class OpenStoryMemory(val bookUrl: String) : BookInfoEffect
    ...
    data class OpenEbookExportDirectory(
        val bookUrl: String,
        val format: String,
        val scope: String,
        val contentSource: String,
