            ...
            Column {
                GlassMediumFlexibleTopAppBar(
                    title = if (searchQuery.isNotBlank() && searchResults.isNotEmpty()) {
                        stringResource(R.string.search_content_result_count, searchResults.size)
                    } else stringResource(R.string.search_content_title),
                    ...
                    actions = {
                        Row(
                            ...
                            TopBarAnimatedActionButton(
                                ...
                                activeText = stringResource(R.string.replacement_enabled),
                                inactiveText = stringResource(R.string.replacement_disabled)
                            )
                            ...
                            TopBarAnimatedActionButton(
                                ...
                                activeText = stringResource(R.string.regex_enabled),
                                inactiveText = stringResource(R.string.regex_disabled)
                            )
                        }
                    },
        ...
        floatingActionButton = {
            ...
            AppFloatingActionButton(
                ...
                tooltipText = stringResource(
                    if (isSearching) R.string.stop_search else R.string.jump_current_chapter
                )
            ) {
                AnimatedContent(
            ...
            AnimatedContent(
                ...
                when (state) {
                    ...
                    SearchContentState.EmptyResult -> {
                        EmptyMessage(
                            message = stringResource(R.string.search_no_matching_content),
                            modifier = Modifier
                                .fillMaxSize()
                                .wrapContentSize()
                        )
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        Box(
            ...
            SmallToggleButton(
                ...
                text = stringResource(R.string.only_this_book)
            )
        }

        if (history.isEmpty()) {
            EmptyMessage(
                message = stringResource(R.string.search_history_empty),
                modifier = Modifier
                    .fillMaxSize()
                    .wrapContentSize()
            )
        ...
        Box(modifier = Modifier.padding(16.dp)) {
            ...
            Row (
                ...
                if (result.progressPercent > 0f) {
                    TextCard(
                        text = String.format(Locale.ROOT, "%.1f%%", result.progressPercent),
                        backgroundColor = LegadoTheme.colorScheme.secondaryContainer,
                        contentColor = LegadoTheme.colorScheme.onSecondaryContainer,
                        cornerRadius = 8.dp,
                        horizontalPadding = 4.dp,
