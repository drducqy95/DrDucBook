...
import com.drducbook.app.databinding.ActivityAudioPlayBinding
...
//        })
    ...
    private fun publishAudioContext() {
        val book = AudioPlay.book
        publishAiScreenContext(
            screen = "AudioPlayActivity",
            attributes = mapOf(
                "bookUrl" to book?.bookUrl,
                "bookName" to book?.name,
                "author" to book?.author,
                "sourceOrigin" to book?.origin,
                "sourceName" to AudioPlay.bookSource?.bookSourceName,
                "chapterIndex" to AudioPlay.durChapterIndex.toString(),
                "chapterSize" to AudioPlay.simulatedChapterSize.toString(),
                "chapterTitle" to AudioPlay.durChapter?.title,
                "status" to AudioPlay.status.toString(),
            )
        )
    }
