...
object ThemeImportExport {
    ...
    fun exportFromCurrent(includeEmbeddedAssets: Boolean = true): ThemeExportData {
        return ThemeExportData(
            ...
            navIconWorkspace = ThemeConfig.navIconWorkspace,
    ...
    private fun exportAssets(): Map<String, String> {
        ...
        val assetPaths = mapOf(
            ...
            "navIconWorkspace" to ThemeConfig.navIconWorkspace,
    ...
    internal fun applyToThemeConfig(
        ...
        ThemeConfig.navIconWorkspace = data.navIconWorkspace
            ...
            try {
                ...
                destFile?.let { file ->
                    ...
                    when {
                        ...
                        key == "navIconWorkspace" -> ThemeConfig.navIconWorkspace = path
...
data class ThemeExportData(
    ...
    val mainNavigationOrder: String = "home,bookshelf,explore,workspace,my",

    // 导航栏图标
    val navIconHome: String = "",
    val navIconBookshelf: String = "",
    val navIconExplore: String = "",
    val navIconWorkspace: String = "",
