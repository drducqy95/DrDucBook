                    ...
                    "myBookShelf.json" ->
                        kotlin.runCatching {
                            doc.uri.readText(context).let { json ->
                                ...
                                context.toastOnUi(
                                    context.getString(R.string.bookshelf_imported_count, importCount)
                                )
                            }
                        }.onFailure {
                            context.toastOnUi(
                                context.getString(R.string.bookshelf_import_failed, it.localizedMessage)
                            )
                        }
                    "myBookSource.json" ->
                        kotlin.runCatching {
                            doc.uri.readText(context).let { json ->
                                ...
                                context.toastOnUi(
                                    context.getString(R.string.sources_imported_count, importCount)
                                )
                            }
                        }.onFailure {
                            context.toastOnUi(
                                context.getString(R.string.sources_import_failed, it.localizedMessage)
                            )
                        }
                    "myBookReplaceRule.json" ->
                        kotlin.runCatching {
                            doc.uri.readText(context).let { json ->
                                ...
                                context.toastOnUi(
                                    context.getString(R.string.rules_imported_count, importCount)
                                )
                            }
                        }.onFailure {
                            context.toastOnUi(
                                context.getString(R.string.rules_import_failed, it.localizedMessage)
                            )
                        }
                }
            }
            ...
            uri.path?.let { path ->
                ...
                kotlin.runCatching {// Replace rules
                    ...
                    if (ruleFile.exists()) {
                        ...
                        context.toastOnUi(R.string.replace_rules_not_found)
                    }
                }.onFailure {
                    context.toastOnUi(
                        context.getString(R.string.rules_import_failed, it.localizedMessage)
