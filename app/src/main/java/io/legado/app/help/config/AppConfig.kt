...
//        }
    ...
    var vbookEbookUnlockCode: String?
        get() = appCtx.getPrefString(PreferKey.vbookEbookUnlockCode)
        set(value) {
            appCtx.putPrefString(PreferKey.vbookEbookUnlockCode, value?.trim().orEmpty())
        }
