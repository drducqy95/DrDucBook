...
object AppUpdateGitHub : AppUpdate.AppUpdateInterface {
    ...
    private val repoPath: String
        get() = BuildConfig.DRDUC_UPDATE_REPOSITORY
    private val githubApiBaseUrl: String
        get() = "https://api.github.com/repos/$repoPath/releases"
    private val updateManifestBaseUrl: String
        get() = "https://raw.githubusercontent.com/$repoPath/update-manifests"
        ...
        companion object {
            fun parse(version: String): SemVer {
                ...
                return SemVer(
                    major = maj.toInt(),
                    minor = min.toInt(),
                    patch = pat.toIntOrNull() ?: 0,
                    preRelease = pre.ifBlank { null },
                )
            }
        }
    }
