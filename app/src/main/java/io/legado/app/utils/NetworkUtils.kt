...
import io.legado.app.domain.webservice.WebServiceAddressCandidate
import io.legado.app.domain.webservice.WebServiceAddressPolicy
...
object NetworkUtils {
    ...
    fun getLocalIPAddress(): List<InetAddress> {
        ...
        val addressByHost = linkedMapOf<String, InetAddress>()
        val candidates = mutableListOf<WebServiceAddressCandidate>()
        ...
        while (enumeration.hasMoreElements()) {
            ...
            while (addresses.hasMoreElements()) {
                ...
                if (!address.isLoopbackAddress && isIPv4Address(address.hostAddress)) {
                    ...
                    addressByHost[host] = address
                    candidates += WebServiceAddressCandidate(
        ...
        return WebServiceAddressPolicy.orderedHosts(candidates).mapNotNull(addressByHost::get)
    }
