...
class AppUpdateGitHubTest {
    ...
    @Test
    fun twoPartMarketingVersionCanBeComparedWithReleaseTags() {
        with(AppUpdateGitHub) {
            assertEquals(0, "1.0".versionCompare("1.0.0"))
            assertTrue("1.0.1".versionCompare("1.0") > 0)
        }
    }
