...
# 数据类
-keep,allowoptimization class io.legado.app.data.entities.** { *; }
# Gson反序列化用的数据传输类
-keep class io.legado.app.model.translation.**{*;}
-keep class io.legado.app.domain.webservice.** { *; }
-keep class io.legado.app.domain.model.DictPair{*;}
-keep class io.legado.app.domain.gateway.NmtDecodeConfig { *; }
-keep class io.legado.app.domain.gateway.NmtTranslationResult { *; }
-keep class io.legado.app.service.NmtOnnxService { *; }
-keep class io.legado.app.service.NmtOnnxIpc { *; }
# The reply crosses the Messenger boundary as a Parcelable ResultReceiver. Keep the
# concrete receiver class emitted inside NmtTranslationRepository so R8 cannot inline
...
-keep class io.legado.app.domain.model.AiTranslationStoryRelationship{*;}
-keep class io.legado.app.domain.model.AiTranslationWorldEntry{*;}
-keep class io.legado.app.domain.model.AiTranslationStoryTimeline{*;}
-keep class io.legado.app.domain.model.AiTranslationTimelineCharacter{*;}
-keep class io.legado.app.domain.model.AiTranslationStoryMemoryDelta{*;}
-keep class io.legado.app.domain.model.VbookCapabilityProfile{*;}
-keep class io.legado.app.domain.model.VbookCapability{*;}
-keep class io.legado.app.domain.model.VbookCapabilityEvidence{*;}
-keep class io.legado.app.domain.model.VbookCapabilityEvidenceKind{*;}
-keep class io.legado.app.domain.model.VbookPluginKind{*;}
...
# sherpa-onnx JNI resolves Kotlin bridge classes and configuration fields by name.
# Renaming any of them makes GetFieldID return null and aborts the whole process.
-keep class com.k2fsa.sherpa.onnx.** { *; }

# ONNX Runtime's JNI bridge materializes TensorInfo/OnnxValue implementations by
# name while validating imported Valtec models. R8 can otherwise remove or rename
# TensorInfo, leaving a pending ClassNotFoundException inside native OrtSession.run
# and aborting the release process with SIGABRT.
