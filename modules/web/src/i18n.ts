...
const additionalMessages: Record<WebLocale, Record<string, string>> = {
  vi: {
    ...
    searchTranslationFailed: 'Không thể dịch từ khóa sang tiếng Trung. Đang tìm bằng từ khóa gốc.',
    searchTranslationUnchanged: 'Từ khóa không thay đổi sau khi dịch.',
    translatingKeyword: 'Đang dịch từ khóa…',
    noTranslationProvider: 'Chưa có bộ dịch khả dụng để dịch từ khóa.',
    catalog: 'Mục lục',
    readerSettings: 'Cài đặt',
    translate: 'Dịch',
    bookshelf: 'Kệ sách',
    toTop: 'Đầu trang',
    toBottom: 'Cuối trang',
    ...
    retry: 'Thử lại',
    cancelTranslation: 'Hủy dịch',
    originalText: 'Bản gốc',
    translatedText: 'Bản dịch',
    translating: 'Đang dịch',
    readingTranslation: 'Đang đọc bản dịch',
    translationCancelled: 'Đã hủy dịch',
    translationError: 'Dịch lỗi',
    firstChapter: 'Đây là chương đầu',
    lastChapter: 'Đây là chương cuối',
    alreadyAtTop: 'Đã ở đầu trang',
    alreadyAtBottom: 'Đã ở cuối trang',
    chapterTranslated: 'Đã dịch chương',
    cannotTranslateChapter: 'Không thể dịch chương',
    cannotUpdateTranslationStatus: 'Không thể cập nhật trạng thái dịch',
    noTranslationAutoOff: 'Chương chưa có bản dịch; Dịch tự động đang tắt trong WebService',
    cannotReadOrCreateTranslation: 'Không thể đọc hoặc tạo bản dịch cho chương',
    selectProviderAndTargetLangFirst: 'Hãy chọn provider và ngôn ngữ đích trước',
    pretranslateStarted: 'Đã bắt đầu dịch trước {count} chương',
    cannotPretranslateChapters: 'Không thể dịch trước chương',
    cannotResumeTts: 'Không thể tiếp tục phát TTS',
    finishedReadingBook: 'Đã đọc hết sách',
    cannotPlayTts: 'Không thể phát TTS từ ứng dụng',
    cannotCancelTranslation: 'Không thể hủy dịch chương',
    bookInfoEmpty: 'Thông tin sách trống, sắp tự quay về kệ sách...',
    emptyChapterContent: 'Nội dung chương đang trống. Hãy thử tải lại.',
    cannotLoadChapterContent: 'Không tải được nội dung chương.',
    cannotLoadChapterConnection: 'Không tải được nội dung chương. Hãy kiểm tra kết nối và thử lại.',
    chapterNotFound: 'Không tìm thấy chương cần đọc. Hãy tải lại mục lục.',
    addToShelfPrompt: 'Có thêm “{name}” vào kệ sách không?',
    addToShelf: 'Thêm vào kệ sách',
    confirm: 'Xác nhận',
    cancel: 'Không',
    ttsVoice: 'Giọng đọc TTS',
    ttsVoiceDescription: 'Chọn bộ đọc và giọng đọc TTS cho ứng dụng và dịch vụ web.',
    ttsEngine: 'Bộ đọc / Giọng đọc',
    selectVoice: 'Giọng cụ thể',
    previewVoice: 'Nghe thử',
    systemTts: 'Hệ thống Android',
    localModel: 'Mô hình Offline (ONNX)',
    httpTts: 'Nguồn mạng (HttpTTS)',
    previewText: 'Xin chào, đây là giọng đọc mẫu của DrDucBook.',
    ttsPreviewFailed: 'Không thể nghe thử giọng đọc.',
    ttsModelSaved: 'Đã đổi giọng đọc thành công.',
    noTtsModels: 'Không có model TTS nào',
    currentEngine: 'Đang dùng',
    speechRate: 'Tốc độ đọc',
    followSystemSpeed: 'Theo hệ thống',
    speechRateSaved: 'Đã cập nhật tốc độ đọc.',
    selectSource: 'Chọn nguồn sách',
    selectCategory: 'Chọn danh mục',
    loadMore: 'Tải thêm',
    noCategories: 'Nguồn này không có danh mục khám phá riêng',
    allCategories: 'Mặc định',
    kindInput: 'Nhập giá trị',
    loadingCategories: 'Đang tải danh mục...',
    loadingMore: 'Đang tải thêm...',
    noMoreBooks: 'Đã tải hết sách',
    retranslateChapter: 'Dịch lại chương',
    translateNow: 'Dịch ngay',
    noTranslationForProvider: 'Chưa có bản dịch cho nhà cung cấp này',
    staleTranslation: 'Bản dịch cũ',
    cachedTranslation: 'Đã có cache',
    userEdited: 'Đã chỉnh sửa',
    translationDashboard: 'Trung tâm dịch thuật',
    activeJobs: 'Tiến trình dịch đang chạy',
    providerCaches: 'Bộ nhớ đệm theo Provider',
    pretranslateControl: 'Dịch trước hàng loạt',
    memoryStats: 'Thống kê bộ nhớ dịch & Thế giới quan',
    globalTerms: 'Thuật ngữ toàn cục',
    projectTerms: 'Thuật ngữ theo truyện',
    characterProfiles: 'Hồ sơ nhân vật',
    factions: 'Thế lực / Tông môn',
    storyEvents: 'Sự kiện dòng thời gian',
    worldEntries: 'Thế giới quan & Khám phá',
    selectBook: 'Chọn truyện',
    fromChapter: 'Từ chương',
    chapterCount: 'Số lượng chương',
    startPretranslate: 'Bắt đầu dịch hàng loạt',
    noActiveJobs: 'Không có tiến trình dịch nào đang chạy.',
    viewGlossary: 'Xem thuật ngữ',
    viewStoryMemory: 'Xem hồ sơ truyện',
    relationships: 'Mối quan hệ',
    aliases: 'Tên gọi khác',
    noGlossaryTerms: 'Chưa có thuật ngữ riêng cho truyện này.',
    noStoryMemory: 'Chưa có dữ liệu hồ sơ hoặc thế giới quan cho truyện này.',
    cacheStatus: 'Trạng thái cache',
    allChapters: 'Tất cả chương',
    viewSeriesMemory: 'Xem toàn bộ series',
    bookGroup: 'Nhóm sách / Series',
  ...
  en: {
    ...
    searchTranslationFailed: 'Failed to translate keyword to Chinese. Searching with original keyword.',
    searchTranslationUnchanged: 'Keyword unchanged after translation.',
    translatingKeyword: 'Translating keyword…',
    noTranslationProvider: 'No translation provider available for keyword.',
    ...
    readingTranslation: 'Reading translation',
    ...
    chapterTranslated: 'Chapter translated',
    cannotTranslateChapter: 'Could not translate chapter',
    cannotUpdateTranslationStatus: 'Could not update translation status',
    noTranslationAutoOff: 'Chapter has no translation; Auto-translation is disabled in WebService',
    cannotReadOrCreateTranslation: 'Could not load or create chapter translation',
    selectProviderAndTargetLangFirst: 'Please select a provider and target language first',
    pretranslateStarted: 'Started pretranslating {count} chapters',
    cannotPretranslateChapters: 'Could not pretranslate chapters',
    cannotResumeTts: 'Could not resume TTS playback',
    finishedReadingBook: 'Finished reading book',
    cannotPlayTts: 'Could not play TTS from app',
    cannotCancelTranslation: 'Could not cancel translation',
    bookInfoEmpty: 'Book information is empty, returning to library...',
    emptyChapterContent: 'Chapter content is empty. Please reload.',
    cannotLoadChapterContent: 'Could not load chapter content.',
    cannotLoadChapterConnection: 'Could not load chapter content. Please check connection and retry.',
    chapterNotFound: 'Chapter not found. Please reload catalog.',
    addToShelfPrompt: 'Add “{name}” to library?',
    addToShelf: 'Add to library',
    confirm: 'Confirm',
    cancel: 'Cancel',
    ttsVoice: 'TTS Voice',
    ttsVoiceDescription: 'Select the TTS engine and voice for app and web service.',
    ttsEngine: 'Engine / Voice',
    selectVoice: 'Voice variant',
    previewVoice: 'Preview',
    systemTts: 'Android System',
    localModel: 'Offline Model (ONNX)',
    httpTts: 'Network (HttpTTS)',
    previewText: 'Hello, this is a sample voice for DrDucBook.',
    ttsPreviewFailed: 'Could not preview voice.',
    ttsModelSaved: 'TTS voice changed successfully.',
    noTtsModels: 'No TTS models available',
    currentEngine: 'Active',
    speechRate: 'Speech Rate',
    followSystemSpeed: 'Follow system',
    speechRateSaved: 'Speech rate updated.',
    selectSource: 'Select book source',
    selectCategory: 'Select category',
    loadMore: 'Load more',
    noCategories: 'This source has no custom discovery categories',
    allCategories: 'Default',
    kindInput: 'Enter value',
    loadingCategories: 'Loading categories...',
    loadingMore: 'Loading more...',
    noMoreBooks: 'No more books',
    retranslateChapter: 'Retranslate chapter',
    translateNow: 'Translate now',
    noTranslationForProvider: 'No cached translation for this provider',
    staleTranslation: 'Stale translation',
    cachedTranslation: 'Cached',
    userEdited: 'User edited',
    translationDashboard: 'Translation Dashboard',
    activeJobs: 'Active Translation Jobs',
    providerCaches: 'Provider Cache Browser',
    pretranslateControl: 'Batch Pretranslate',
    memoryStats: 'Translation Memory & Worldbuilding Stats',
    globalTerms: 'Global Dictionary Terms',
    projectTerms: 'Project Glossary Terms',
    characterProfiles: 'Character Profiles',
    factions: 'Factions & Sects',
    storyEvents: 'Timeline Events',
    worldEntries: 'Worldbuilding & Discoveries',
    selectBook: 'Select book',
    fromChapter: 'From chapter',
    chapterCount: 'Chapter count',
    startPretranslate: 'Start batch pretranslate',
    noActiveJobs: 'No active translation jobs.',
    viewGlossary: 'View Glossary',
    viewStoryMemory: 'View Story Memory',
    relationships: 'Relationships',
    aliases: 'Aliases',
    noGlossaryTerms: 'No custom glossary terms for this book.',
    noStoryMemory: 'No character profiles or worldbuilding data for this book.',
    cacheStatus: 'Cache status',
    allChapters: 'All chapters',
    viewSeriesMemory: 'View whole series',
    bookGroup: 'Book Group / Series',
    inheritSeriesMemory: 'Inherit series memory',
  ...
  'zh-CN': {
    ...
    searchTranslationFailed: '关键词翻译失败，使用原关键词搜索。',
    searchTranslationUnchanged: '翻译后关键词未变。',
    translatingKeyword: '正在翻译关键词…',
    noTranslationProvider: '暂无可用翻译源。',
    catalog: '目录',
    readerSettings: '设置',
    translate: '翻译',
    bookshelf: '书架',
    ...
    translatedText: '译文',
    translating: '翻译中',
    readingTranslation: '正在阅读译文',
    translationCancelled: '已取消翻译',
    translationError: '翻译错误',
    firstChapter: '这是第一章',
    lastChapter: '这是最后一章',
    alreadyAtTop: '已在顶部',
    alreadyAtBottom: '已在底部',
    chapterTranslated: '章节已翻译',
    cannotTranslateChapter: '无法翻译章节',
    cannotUpdateTranslationStatus: '无法更新翻译状态',
    noTranslationAutoOff: '章节暂无翻译；WebService 中已关闭自动翻译',
    cannotReadOrCreateTranslation: '无法加载或创建章节翻译',
    selectProviderAndTargetLangFirst: '请先选择服务商和目标语言',
    pretranslateStarted: '已开始预翻译 {count} 章',
    cannotPretranslateChapters: '无法预翻译章节',
    cannotResumeTts: '无法继续播放 TTS',
    finishedReadingBook: '已读完整本书',
    cannotPlayTts: '无法从应用播放 TTS',
    cannotCancelTranslation: '无法取消翻译',
    bookInfoEmpty: '书籍信息为空，即将返回书架...',
    emptyChapterContent: '章节内容为空，请尝试重新加载。',
    cannotLoadChapterContent: '无法加载章节内容。',
    cannotLoadChapterConnection: '无法加载章节内容，请检查连接后重试。',
    chapterNotFound: '未找到章节，请刷新目录。',
    addToShelfPrompt: '是否将“{name}”加入书架？',
    addToShelf: '加入书架',
    confirm: '确认',
    cancel: '取消',
    ttsVoice: 'TTS 语音',
    ttsVoiceDescription: '选择应用和网页服务的 TTS 语音引擎。',
    ttsEngine: '语音引擎',
    selectVoice: '子音色',
    previewVoice: '试听',
    systemTts: '系统 TTS',
    localModel: '离线模型 (ONNX)',
    httpTts: '网络源 (HttpTTS)',
    previewText: '您好，这是 DrDucBook 的示例朗读语音。',
    ttsPreviewFailed: '无法试听语音。',
    ttsModelSaved: '已成功更改朗读语音。',
    noTtsModels: '暂无 TTS 模型',
    currentEngine: '使用中',
    speechRate: '朗读语速',
    followSystemSpeed: '跟随系统',
    speechRateSaved: '已更新朗读语速。',
    selectSource: '选择书源',
    selectCategory: '选择分类',
    loadMore: '加载更多',
    noCategories: '该书源没有自定义发现分类',
    allCategories: '默认',
    kindInput: '输入内容',
    ...
    translateNow: '立即翻译',
    noTranslationForProvider: '此服务商尚无缓存翻译',
    staleTranslation: '陈旧翻译',
    cachedTranslation: '已缓存',
    userEdited: '已人工编辑',
    translationDashboard: '翻译中心',
    activeJobs: '正在运行的翻译任务',
    providerCaches: '各引擎缓存浏览',
    pretranslateControl: '批量预翻译',
    memoryStats: '翻译记忆与世界观统计',
    globalTerms: '全局词库条目',
    projectTerms: '专有词汇条目',
    ...
    fromChapter: '起始章节',
    chapterCount: '章节数量',
    startPretranslate: '开始批量预翻译',
    noActiveJobs: '当前没有运行中的翻译任务。',
    viewGlossary: '查看专有词',
    viewStoryMemory: '查看故事记忆',
    relationships: '人物关系',
    aliases: '别名',
    noGlossaryTerms: '本书尚无专有词汇。',
    noStoryMemory: '本书尚无人物或世界观档案。',
    cacheStatus: '缓存状态',
    allChapters: '全部章节',
    viewSeriesMemory: '查看整个系列',
    bookGroup: '书籍分组 / 系列',
    inheritSeriesMemory: '继承系列记忆',
    allGroups: '所有分组',
  },
}
...
export const translateDynamicTexts = async (scopeKey: string, values: Array<string | null | undefined>) => {
  ...
  const needed = unique.filter(text => !dynamicMessages[`${scopeKey}:${webLocale.value}:${text}`])
  if (needed.length === 0) return
  try {
    for (let i = 0; i < needed.length; i += 50) {
      const batch = needed.slice(i, i + 50)
      const result = await translateWebServiceUi(`dynamic:${scopeKey}`, batch, webLocale.value)
