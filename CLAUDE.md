...
- Supabase Auth/Postgrest/Storage/Functions are configured through public build variables; Google Drive backup remains a separate optional authorization flow
